...
from src.prompts.injury_agent import injury_agent_desc, injury_agent_inst
from src.tools.injury_tool import get_injury_advice_tool
import src.config as config


# Define individual agent
injury_agent = LlmAgent(
    name="injury_agent",
...
print(f"Agent '{injury_agent.name}' created using model '{config.LLM_MODEL}'.")
