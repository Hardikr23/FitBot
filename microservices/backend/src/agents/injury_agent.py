...
injury_agent = LlmAgent(name="injury_agent", model="gemini-2.0-flash")
...
# YOUR_DATASTORE_ID = config.INJURY_DS_ID

# # Constants
# APP_NAME_VSEARCH = "injury_search_app"
# USER_ID_VSEARCH = "user_vsearch_1"
# SESSION_ID_VSEARCH = "session_vsearch_1"
# AGENT_NAME_VSEARCH = "injury_search_agent"
